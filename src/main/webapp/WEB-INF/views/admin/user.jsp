...
<head>
    ...
    <link rel="stylesheet" href="${staticPath }/static/css/AdminLTE.min.css">
    <link rel="stylesheet" href="${staticPath }/static/css/skin-red.min.css">
                            ...
                            <li>
                                <ul class="menu">
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${path }/static/img/user2-160x160.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${path }/static/img/user3-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${path }/static/img/user4-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="${staticPath}/static/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="${path }/user/manager"><i class="fa fa-circle-o text-red"></i>
                    <span>User Manager</span></a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
...
<script src="${staticPath }/static/js/app.min.js"></script>
<script>
    $(function () {
